              ...
              return (
                ...
                >
                  ...
                  <div className="flex sm:justify-end shrink-0">
                    {isPendingQuote ? (
                      <BookingQuoteDialog booking={booking} />
                    ) : (
                      <Badge className="bg-amber-50 text-amber-700 border border-amber-200 text-3xs font-bold uppercase tracking-wider px-3 py-1.5 rounded-lg select-none">
                        Awaiting Response
                      </Badge>
                    )}
                  </div>
